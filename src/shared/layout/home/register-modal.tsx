...
const RegisterModal: React.FC<IregisterModalProps> = props => {
  ...
  return (
    <Modal isOpen toggle={handleClose} backdrop id="register-modal" autoFocus={false}>
      <Form id="register-form" onSubmit={handleSubmit}>
        ...
        <ModalFooter>
          <Button type="button" color="secondary" onClick={handleClose} tabIndex={1} disabled={props.registerSuccess}>
            Annulla
          </Button>{' '}
          <Button color="primary" type="button" onClick={handleSubmit} disabled={props.registerSuccess} >
            register
          </Button>
        </ModalFooter>
      </Form>
